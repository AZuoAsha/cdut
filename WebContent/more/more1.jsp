	        ...
	        success: function (data ,textStatus, jqXHR)
	        {
	        	var oj = JSON.parse(data);
			    	...
			    	var txt1=$(".content .demo #div1");
			      	var txt2=$("<a style='color:#613030;font-size:16px;padding-top:10px;' target='_blank'><li style='float:left;'></li></a><img src='images/new.gif'><br>").text(html).attr("id","new_title_"+i);
...
<div class="contain" style="margin-top: -14px">
  ...
  <div class="listr right">
    <h2><span>您现在的位置: <a href="index.jsp" target="_blank">网站首页</a>>>党建理论</span>党建理论</h2>
