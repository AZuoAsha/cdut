...
<ul id="carousel">
	...
	<!-- <li><img src="images/banner3.jpg" style="width:1000px;height:300px;border:1px solid #DDFF77;"></li> --><li><a href="receive/findOneTo.do?newsType=10&newsTittle=广州：双胞胎大熊猫断母乳 迈出独立生活第一步"><img src="images/banner5.jpg" style="width:1000px;height:450px;border:1px solid #DDFF77;"></a></li>
...
<div class="contain" style="margin-top: -14px">
  ...
  <div class="listr right">
    <h2><span>您现在的位置: <a href="index.jsp" target="_blank">网站首页</a>>>基层党建</span>基层党建</h2>
