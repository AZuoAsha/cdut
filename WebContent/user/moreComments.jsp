...
<div class="contain" style="margin-top: -14px">
  ...
  <div class="listr right">
    <h2><span>您现在的位置: <a href="index.jsp">网站首页</a>>>更多评论</span>更多评论</h2>
		...
		<div class="content">
			<div id="paginationdemo" class="demo">
                <div id="p1" class="pagedemo _current"> 
	                ...
	                <div align="center"> ${sessionScope.newsTitle}</div><hr><br>
	                 <p style="width: 598px;height:30px;background:#DDDDDD;border-left:1px solid #AAAAAA;border-right:1px solid #AAAAAA;border-top:1px solid #AAAAAA;margin-left:180px"><span style="color:#AAAAAA;font-size: 14px;margin-left:0px">来啊造作啊</span>|<span>≡(▔﹏▔)≡</span></p>
                     ...
                     id="commentContext"></textarea><br><div style="width:503px;height:31px; margin-left:180px;position:relative;background:#ccc;float:left;border-bottom:1px solid #AAAAAA;border-left:1px solid #AAAAAA;color:#AAAAAA">文明上网、不传谣言、登陆评论</div><button onclick="submitComment()" style="font-size: 24px;background:red;color:white;margin-top:0px;border:none;cursor:pointer;float:right;margin-right:186px;height:32px;">发表评论</button><br><br><br>
                     <div style="width:580px;white-space:nowrap;background:#ccc;height:auto;margin-left:190px;overflow:hidden;border-left:1px solid #AAAAAA;border-top:1px solid #AAAAAA;border-right:1px solid #AAAAAA;"><span style="font-size: 20px;color:red;margin-left:0px;width:200px;height:31px;padding-right:200px;padding-top:1px;background:#ccc;padding-bottom:2px">全部评论</span><span id="pl" style="color:#613030;font-size:16px;margin-left:0px;width:200px;height:31px;padding-right:212px;padding-top:5px;background:#ccc;padding-bottom:2.5px"></span>
                    </div>
 <div id="div1" style="border: 1px solid #ccc;width:60%;height:auto;margin-left:190px;list-style-type:none;text-align:center">
...
<script>
    submitComment=function(){
            ...
            var newId= "${sessionScope.id}" ;
            var commentUser="${sessionScope.userMail}";
            var newsTitle= "${sessionScope.newsTitle}" ;
       //  alert(newsTitle);
           // alert("ieLogin="+isLogin);
            if(isLogin=='false'){
                if(confirm("你还没有登录，现在去登录吗")){
                 //   alert("你点击了确定");
                ...
                if(commentContext==''){
                    ...
                    if (data == 'success') {
                      //  alert("评论成功");
                   window.location.href="${pageContext.request.contextPath}/user/moreComments.jsp";
                    } else {
                      alert("评论失败");
                    }
                    },
...
<script>
     $(document).ready(function () {
        ...
        var me="${pageContext.request.contextPath}";//alert(me);
            var commentUsers="${sessionScope.userMail}";
            var newsTittle= "${sessionScope.newsTitle}" ;
            var isLogin2="${sessionScope.isLogin}";
           // alert("id="+newsId+",commentUser="+commentUser);
           if(newsIds==''&&isLogin2=='false'){
